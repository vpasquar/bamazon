...
function viewSales() {
  var query = "SELECT departProd.department_id, departProd.department_name, departProd.over_head_costs," +
              ...
              " IFNULL(products.product_sales, 0) as product_sales FROM products" +
